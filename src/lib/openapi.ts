...
const ENDPOINTS: Ep[] = [
  ...
  { method: "GET", path: "/au-check", price: "0.001", description: "Checkify extras catalogue." },
  { method: "GET", path: "/au-check/postcode", price: "0.01", description: "Suburbs in a postcode." },
  { method: "GET", path: "/au-check/reverse", price: "0.01", description: "Reverse geocode." },
  { method: "GET", path: "/au-check/suburb", price: "0.005", description: "Suburb autocomplete." },
  { method: "GET", path: "/au-check/activity", price: "0.005", description: "ANZSIC activity search." },
  { method: "GET", path: "/au-check/company-name", price: "0.01", description: "Company name availability." },
  { method: "GET", path: "/au-check/business-name", price: "0.01", description: "Business name availability." },
  { method: "GET", path: "/au-check/sanctions", price: "0.03", description: "Sanctions screening." },
  { method: "GET", path: "/au-check/director-id", price: "0.01", description: "Director ID checksum." },
  { method: "GET", path: "/au-check/tfn", price: "0.01", description: "TFN checksum." },
  { method: "GET", path: "/au-check/email", price: "0.01", description: "Email validation." },
