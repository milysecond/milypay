...
import { MD_PRIVACY } from "@/lib/agent-markdown";

export const metadata: Metadata = {
  title: "Privacy — Milypay",
  description:
    "Privacy policy for Milypay: how we handle API requests, payments, analytics, and contact data.",
