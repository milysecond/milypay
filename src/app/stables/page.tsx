...
const STABLES: {
  ...
  },
  {
    ...
    chains: "Ethereum, Redbelly (Solana & Sui planned)",
    solana: "Planned",
    status: "planned",
    statusLabel: "Institutional · Solana planned",
    desc: "Built for settlement infrastructure, tokenised assets, and wholesale markets. MilyPay will route to AUDM for agents once it lands on Solana.",
  },
  {
    ticker: "dAUD",
    name: "Decentralized AUD",
    issuer: "On-chain / DeFi-native",
    regulatory: "Protocol-governed",
    chains: "Emerging",
    solana: "Emerging",
    status: "emerging",
    statusLabel: "Emerging · Decentralized",
    desc: "A decentralized, on-chain AUD unit for trust-minimised settlement. Forward-looking - MilyPay tracks dAUD as the decentralized complement to regulated issuers.",
  },
  {
    ticker: "A$DC",
    name: "ANZ A$DC",
