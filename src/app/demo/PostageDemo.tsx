...
export default function PostageDemo() {
  ...
  const field = (label: string, value: string, set: (v: string) => void, ph: string) => (
    <label className="flex-1">
      ...
      <input
        ...
        placeholder={ph}
        className="mt-1 w-full rounded-md border border-border-brand bg-card px-4 py-2.5 text-fg outline-none placeholder:text-muted/50 focus:border-brand-green"
      />
    </label>
  );
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 pb-24">
      ...
      >
        <div className="mb-4 inline-flex border border-border-brand bg-card p-1 gap-1">
